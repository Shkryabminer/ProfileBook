...
namespace ProfileBook.ViewModels
{
    public class MainListViewViewModel : BaseViewModel
    {
        ...
        public IRepository<Profile> Repository { get; private set; }
        ...
        //}
        public MainListViewViewModel(INavigationService navigationService, IRepository<Profile> repository, IAutorization autorization) : base(navigationService)
        {
        ...
        public override async void OnNavigatedTo(INavigationParameters parameters)
        {
            ...
            if (Autorizator.Autorizeted())
            {
                var query = from p in Repository.GetItems()
